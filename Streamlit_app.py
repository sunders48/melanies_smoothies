...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        search_onresponse = requests.get("https://fruityvice.com/api/fruit/watermelon" +  search_on)
        fv_df = st.dataframe(data=search_onresponse.json(),use_container_width=True)
